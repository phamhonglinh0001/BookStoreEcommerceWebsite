...
if(isset($_SESSION["MSAD"])){
    ...
    $_SESSION["dieuhuong"] = "them_nv.php";
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql = "select MSNV from nhanvien where SoDienThoai='$sdt'";
    $data = mysqli_fetch_all(mysqli_query($conn, $sql), MYSQLI_ASSOC);
    if(count($data)>0) $_SESSION["err_them_nv"] = "Số điện thoại đã tồn tại";
    else{
        $sql = "insert into nhanvien(HoTenNV, Password, DiaChi, SoDienThoai, ChucVu) 
        values('$ten','$mk','$diachi','$sdt','$chucvu')";
        mysqli_query($conn, $sql);
        
        $_SESSION["err_them_nv"] = "Thêm nhân viên thành công";
    }
}
        ...
        <div class="mx-auto" style="min-height: 80vh; width: 80%; padding:50px;">
            ...
            <div class="text-center">
                <span class="text-danger">
                    <?php
                        if(isset($_SESSION["err_them_nv"])){
                            echo $_SESSION["err_them_nv"];
                            unset($_SESSION["err_them_nv"]);
                        }
                    ?>
                </span>
            </div>
            ...
            <div class="table-responsive mx-auto" style="width:70%;">
                ...
                <table class="table table-bordered text-end">
                    <tr>
                        ...
                        <td>
                            <input required placeholder="Nhập họ tên" type="text" class="form-control" name="ten">
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input required placeholder="Nhập mật khẩu" type="text" class="form-control" name="mk">
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <textarea class="form-control" placeholder="Nhập địa chỉ" required name="diachi" cols="50" rows="3"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td>
                            <input required placeholder="Nhập số điện thoại" type="text" class="form-control" name="sdt">
                        </td>
                    </tr>
                </table>
                <div class="text-center">
