...
if(isset($_SESSION["MSNV"])){
    ...
    $_SESSION["err"] = "Bạn hãy đăng nhập để xem chi tiết đơn hàng";
    $_SESSION["dieuhuong"] = "chitiet_donhang.php?SoDonDH='$id'";
...
<body>
    <div class="root">
        ...
        <div class="mx-auto" style="min-height: 80vh; width: 80%; padding:50px;">
            ...
            <br>
            <div class="text-center">
                <a href="donhang.php" class="btn btn-danger">Trở về</a>
            </div>
        </div>
