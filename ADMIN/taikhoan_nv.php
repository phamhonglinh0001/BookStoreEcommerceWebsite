...
if(isset($_SESSION["MSNV"])){
    ...
    $_SESSION["dieuhuong"] = "taikhoan_nv.php";
    ...
    <div class="root">
        ...
        <div class="mx-auto" style="min-height: 80vh; width: 80%; padding:50px;">
            ...
            <form method="post" action="../TONGQUAN/doi_mk.php" class="text-end">
                    <button name="submit" type="submit" value="NV-<?php echo $msnv;?>" class="btn text-primary text-decoration-underline">Đổi mật khẩu</button>
            </form>
            <br>
